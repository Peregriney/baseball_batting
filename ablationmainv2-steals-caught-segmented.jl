    ...
    elseif outs == 2
      ...
      elseif base1 == 1 && base2 == 0 && base3 == 0
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  ...
                  f(State(b, j - 1, outs, 0, 1, 1)) * Single(b_next) * single_2_outs + 
                  f(State(b, j - 1, outs, 0, 1, 0)) * Single(b_next) * single_2_outs + 

                  f(State(b, j - 1, outs-1, 0, 1, 1)) * Single(b_next) * caught_1_outs + 
                  f(State(b, j - 1, outs-1, 0, 1, 0)) * Single(b_next) * caught_1_outs
      ...
      elseif base1 == 1 && base2 == 1 && base3 == 0
          value = f(State(b,j-1,outs-1,base1,base2,base3)) * OutGet(b_next) +
                  ...
                  f(State(b, j - 1, outs, 1, 1, 1)) * Single(b_next) * single_2_outs + 
                  f(State(b, j - 1, outs, 1, 1, 0)) * Single(b_next)* single_2_outs + 
                  f(State(b, j - 1, outs-1, 1, 1, 1)) * Single(b_next) * caught_1_outs + 
                  f(State(b, j - 1, outs-1, 1, 1, 0)) * Single(b_next)* caught_1_outs 
      elseif base1 == 1 && base2 == 0 && base3 == 1
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  f(State(b, j - 1, outs, 0, 0, 1)) * Walk(b_next) +
                  f(State(b, j - 1, outs, 0, 1, 0)) * Single(b_next) * (1- single_2_outs) +
                  f(State(b, j - 1, outs, 0, 1, 1)) * Single(b_next) * (1- single_2_outs)
      ...
      elseif base1 == 1 && base2 == 1 && base3 == 1
          value = f(State(b,j-1,outs-1,base1,base2,base3)) * OutGet(b_next) +
                  ...
                  f(State(b, j - 1, outs, 1, 1, 0)) * Single(b_next) * (1- single_2_outs) +
                  f(State(b, j - 1, outs, 1, 1, 1)) * Single(b_next) * (1- single_2_outs)
      end
    ...
    elseif outs == 1
      ...
      elseif base1 == 1 && base2 == 0 && base3 == 0
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  ...
                  f(State(b, j - 1, outs, 0, 0, 0)) * Single(b_next) +
                  f(State(b, j - 1, outs, 0, 0, 1)) * Single(b_next) + 
                  f(State(b, j - 1, outs, 0, 1, 1)) * Single(b_next) * single_1_outs + 
                  f(State(b, j - 1, outs, 0, 1, 0)) * Single(b_next) * single_1_outs +
                  f(State(b, j - 1, outs-1, 0, 1, 1)) * Single(b_next) * caught_0_outs + 
                  f(State(b, j - 1, outs-1, 0, 1, 0)) * Single(b_next) * caught_0_outs
      elseif base1 == 0 && base2 == 1 && base3 == 0
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  f(State(b, j - 1, outs, 0, 0, 0)) * Double(b_next) +
                  f(State(b, j - 1, outs, 0, 1, 0)) * Double(b_next) +
      ...
      elseif base1 == 1 && base2 == 1 && base3 == 0
          value = f(State(b,j-1,outs-1,base1,base2,base3)) * OutGet(b_next) +
                  ...
                  f(State(b, j - 1, outs, 1, 0, 0)) * Single(b_next) +
                  f(State(b, j - 1, outs, 1, 0, 1)) * Single(b_next) +
                  f(State(b, j - 1, outs, 1, 1, 1)) * Single(b_next) * single_1_outs + 
                  f(State(b, j - 1, outs, 1, 1, 0)) * Single(b_next) * single_1_outs +
                  f(State(b, j - 1, outs-1, 1, 1, 1)) * Single(b_next) * caught_0_outs + 
                  f(State(b, j - 1, outs-1, 1, 1, 0)) * Single(b_next) * caught_0_outs
      elseif base1 == 1 && base2 == 0 && base3 == 1
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  f(State(b, j - 1, outs, 0, 0, 1)) * Walk(b_next) +
                  f(State(b, j - 1, outs, 0, 1, 0)) * Single(b_next) * (1- single_1_outs) +
                  f(State(b, j - 1, outs, 0, 1, 1)) * Single(b_next) * (1- single_1_outs)
      elseif base1 == 0 && base2 == 1 && base3 == 1
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  f(State(b, j - 1, outs, 1, 0, 0)) * Double(b_next) +
                  f(State(b, j - 1, outs, 1, 1, 0)) * Double(b_next) +
      ...
      elseif base1 == 1 && base2 == 1 && base3 == 1
          value = f(State(b,j-1,outs-1,base1,base2,base3)) * OutGet(b_next) +
                  ...
                  f(State(b, j - 1, outs, 0, 1, 1)) * Walk(b_next) +
                  f(State(b, j - 1, outs, 1, 1, 1)) * Walk(b_next) +
                  f(State(b, j - 1, outs, 1, 1, 0)) * Single(b_next) * (1- single_1_outs) +
                  f(State(b, j - 1, outs, 1, 1, 1)) * Single(b_next) * (1- single_1_outs)
      end
    ...
    elseif outs == 0
      ...
      elseif base1 == 1 && base2 == 0 && base3 == 0
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  ...
                  f(State(b, j - 1, outs, 0, 0, 0)) * Single(b_next) +
                  f(State(b, j - 1, outs, 0, 0, 1)) * Single(b_next) + 
                  f(State(b, j - 1, outs, 0, 1, 1)) * Single(b_next) * single_0_outs + 
                  f(State(b, j - 1, outs, 0, 1, 0)) * Single(b_next) * single_0_outs 
      elseif base1 == 0 && base2 == 1 && base3 == 0
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  f(State(b, j - 1, outs, 0, 0, 0)) * Double(b_next) +
                  f(State(b, j - 1, outs, 0, 1, 0)) * Double(b_next) +
                  ...
                  f(State(b, j - 1, outs, 1, 1, 1)) * Single(b_next) * single_0_outs + 
                  f(State(b, j - 1, outs, 1, 1, 0)) * Single(b_next) * single_0_outs
      elseif base1 == 0 && base2 == 0 && base3 == 1 #modified from doc
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  Triple(b_next) * sum(f(State(b, j - 1, outs, b1, b2, b3)) for b1 in [0, 1], b2 in [0, 1], b3 in [0, 1])
      elseif base1 == 1 && base2 == 1 && base3 == 0
      ...
      elseif base1 == 1 && base2 == 0 && base3 == 1
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  f(State(b, j - 1, outs, 0, 0, 1)) * Walk(b_next) +
                  f(State(b, j - 1, outs, 0, 1, 0)) * Single(b_next) * (1- single_0_outs) +
                  f(State(b, j - 1, outs, 0, 1, 1)) * Single(b_next) * (1- single_0_outs)
      elseif base1 == 0 && base2 == 1 && base3 == 1
          value = f(State(b, j - 1, outs-1, base1, base2, base3)) * OutGet(b_next) +
                  f(State(b, j - 1, outs, 1, 0, 0)) * Double(b_next) +
                  f(State(b, j - 1, outs, 1, 1, 0)) * Double(b_next) +
      ...
      elseif base1 == 1 && base2 == 1 && base3 == 1
          value = f(State(b,j-1,outs-1,base1,base2,base3)) * OutGet(b_next) +
                  ...
                  f(State(b, j - 1, outs, 0, 1, 1)) * Walk(b_next) +
                  f(State(b, j - 1, outs, 1, 1, 1)) * Walk(b_next) +
                  f(State(b, j - 1, outs, 1, 1, 0)) * Single(b_next) * (1- single_0_outs) +
                  f(State(b, j - 1, outs, 1, 1, 1)) * Single(b_next) * (1- single_0_outs)
      end
